...
})({"k7CU9":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "ddf1c21027658923";
"use strict";
...
},{}],"hpX6k":[function(require,module,exports) {
var _utils = require("../../common/js/utils");
let params = new URLSearchParams(document.location.search);
let code = params.get("code");
if (!code) document.getElementById("code-refusal-container").hidden = false;
else document.getElementById("inputrefusalcode").value = code;
const sendRemovalRequest = async ()=>{
    const toRemoveEmail = document.getElementById("inputemailtoremove").value;
    if ((0, _utils.looksLikeMail)(toRemoveEmail)) {
        const refusalCode = document.getElementById("inputrefusalcode").value;
        const rqstBody = {
            email: toRemoveEmail,
            refusal_code: refusalCode
        };
        const data = await (0, _utils.callJsonApi)("/refuseinvitation", "POST", rqstBody);
        if (data.ok) {
...
},{}]},["k7CU9","hpX6k"], "hpX6k", "parcelRequire1e7e")

//# sourceMappingURL=refusal.27658923.js.map
