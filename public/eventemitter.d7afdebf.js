...
},{}],"composition/settings.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.enableCompositionSettings = void 0;
...
var CURRENT_PRIVACY = null;
var CURRENT_OPENTOCONTRIB = null;
var ROLES = {
  1: 'Owner',
  2: 'Admin',
  3: 'Member',
...
var enableCompositionSettings = function enableCompositionSettings(tracksInfo) {
...
exports.enableCompositionSettings = enableCompositionSettings;
var setUIPrivacy = function setUIPrivacy(privacyLevel) {
  CURRENT_PRIVACY = privacyLevel;
  var radiobtn = document.getElementById('settingsPrivacyRadios' + privacyLevel);
  radiobtn.checked = true;
};
var setUITitle = function setUITitle(title) {
  CURRENT_TITLE = title;
  var textfield = document.getElementById('newtitle');
  textfield.value = title;
};
var setOpenToContrib = function setOpenToContrib(status) {
  CURRENT_OPENTOCONTRIB = status;
  var checkbox = document.getElementById('opentocontribution');
  checkbox.checked = status;
};
var setUIContributors = function setUIContributors(contributors, compositionId) {
  var button = document.getElementById('addContribButton');
  var input = document.getElementById('contributorinput');
  var ul = document.getElementById('listOfContributors');
  if (contributors.length) {
    contributors.flatMap(function (elem) {
      return addContributorToUI(ul, elem);
    });
  }
  button.addEventListener('click', function () {
    var roleInput = document.getElementById('inputGroupSelectRole');
...
var addContributorToUI = function addContributorToUI(ul, contrib) {
  var role = ROLES[contrib.role];
  var li = document.createElement('li');
  li.className = 'list-group-item';
  li.textContent = contrib.user_id + ' (' + role + ')';
  ul.appendChild(li);
};
var addContributorToList = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(ul, contrib, compositionId, role) {
    var data, resultAddContrib;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return updateSettings('POST', '/addcontributorbyid', data);
        case 3:
          resultAddContrib = _context.sent;
  ...
  return function addContributorToList(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
var updateSettings = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(method, api, data) {
    var body, response, request, sendRqst, respToJson;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 3;
          _context2.next = 6;
          return fetch(_config.ENDPOINT + api, request);
        case 6:
          sendRqst = _context2.sent;
          _context2.next = 9;
          return sendRqst.json();
        case 9:
          respToJson = _context2.sent;
          if (respToJson) {
            response = respToJson;
          }
          _context2.next = 16;
  ...
  return function updateSettings(_x5, _x6, _x7) {
    return _ref2.apply(this, arguments);
  };
}();
var saveButtonHandler = function saveButtonHandler(compId) {
  var confirmSettingsButton = document.getElementById('updatecompositionbutton');
  confirmSettingsButton && confirmSettingsButton.addEventListener('click', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(e) {
      var deleteComp, newtitle, newPrivacyLevel, privacy, newOpenToContrib;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            deleteComp = document.getElementById('deleteComposition').checked;
            if (!(deleteComp === true)) {
              _context3.next = 6;
              break;
            }
          ...
          case 6:
            ...
            _context3.next = 10;
            return updateTitle(compId, newtitle);
          case 10:
            newPrivacyLevel = document.querySelector('input[name="settingsPrivacyRadios"]:checked').value;
            privacy = parseInt(newPrivacyLevel);
            if (!(privacy !== CURRENT_PRIVACY)) {
              _context3.next = 15;
              break;
            }
            _context3.next = 15;
            return updatePrivacy(compId, privacy);
          case 15:
            newOpenToContrib = document.getElementById('opentocontribution').checked;
            if (!(newOpenToContrib !== CURRENT_OPENTOCONTRIB)) {
              _context3.next = 19;
              break;
            }
            _context3.next = 19;
            return updateOpenToContrib(compId, newOpenToContrib);
          case 19:
...
var updateTitle = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(compId, newtitle) {
    var data, resultNewTitle;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          _context4.next = 3;
          return updateSettings('PATCH', '/updatecomptitle', data);
        case 3:
          resultNewTitle = _context4.sent;
  ...
  return function updateTitle(_x9, _x10) {
    return _ref4.apply(this, arguments);
  };
}();
var updatePrivacy = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(compId, privacy) {
    var data, resultNewPrivacy;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 3;
          return updateSettings('PATCH', '/updateprivacy', data);
        case 3:
          resultNewPrivacy = _context5.sent;
  ...
  return function updatePrivacy(_x11, _x12) {
    return _ref5.apply(this, arguments);
  };
}();
var updateOpenToContrib = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(compId, newstatus) {
    var data, resultNewOpenToContrib;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _context6.next = 3;
          return updateSettings('PATCH', '/updatecomptocontrib', data);
        case 3:
          resultNewOpenToContrib = _context6.sent;
  ...
  return function updateOpenToContrib(_x13, _x14) {
    return _ref6.apply(this, arguments);
  };
}();
var deleteComposition = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(compId) {
    var dialog, data, resultDeleteComp;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          dialog = confirm('Delete ' + CURRENT_TITLE + '?');
          if (!dialog) {
            _context7.next = 7;
            break;
          }
          ...
          _context7.next = 5;
          return updateSettings('DELETE', '/deletecomposition', data);
        case 5:
          resultDeleteComp = _context7.sent;
  ...
  return function deleteComposition(_x15) {
    return _ref7.apply(this, arguments);
  };
}();
},{"../js/config":"js/config.js"}],"composition/composition_helper.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.startLoader = exports.getComposition = exports.doFetch = exports.doAfterCompositionFetched = exports.cancelLoader = exports.CURRENT_USER_ID = void 0;
var _config = require("../js/config");
...
var getComposition = function getComposition(compositionId, callback, extraParams) {
  var errorIs = null;
  var tracksInfo = {};
  fetch(_config.ENDPOINT + "/composition/" + compositionId, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json'
...
var doAfterCompositionFetched = function doAfterCompositionFetched(tracksInfo) {
  createArrayOfTracks(tracksInfo);
  drawCompositionDetailInfo(tracksInfo);
};
exports.doAfterCompositionFetched = doAfterCompositionFetched;
...
var createArrayOfTracks = function createArrayOfTracks(tracksInfo) {
  var canUpload = tracksInfo.owner || 1 <= tracksInfo.role && tracksInfo.role <= 3 || false;
  var userRole = tracksInfo.role;
  exports.CURRENT_USER_ID = CURRENT_USER_ID = tracksInfo.viewer_id;
  if (canUpload) {
    (0, _composition.setUserPermission)(true);
    _composition.fileUploader.enableUpload();
    if (userRole === 1) {
      (0, _settings.enableCompositionSettings)(tracksInfo);
    }
  }
  if (tracksInfo.tracks) {
    ...
    cancelLoader(_composition.LOADER_ELEM_ID);
    _composition.playlist.initExporter();
    _composition.recorder.init();
  }
};
var createTrackList = function createTrackList(arrayLoad, canUpload, userRole) {
  var errorIs = null;
  _composition.playlist.load(arrayLoad).then(function () {
    _composition.playlist.initExporter();
  }).catch(function (error) {
    errorIs = error;
  }).then(function () {
    ...
    if (errorIs) {
      ...
      _composition.recorder.init();
      if (canUpload) {
        _composition.trackHandler.displayOptMenuForTracks(userRole);
      }
    }
  });
};
var drawCompositionDetailInfo = function drawCompositionDetailInfo(tracksInfo) {
  var lyricsHtml = null;
  var compositionName = 'No name';
  var compositionNameHtml = '<h1 class="post-title">No name</h1>';
  var compositionInfo = tracksInfo.compositionInfoById;
  if (compositionInfo && compositionInfo.doc_url) {
    lyricsHtml = "<a href=\"#\" onclick=\"window.open('".concat(compositionInfo.doc_url, "', 'lyrics_popup', 'fullscreen=yes',false); return false\">Lyrics</a>");
    document.getElementById('post-header').insertAdjacentHTML('afterbegin', lyricsHtml);
  }
  if (tracksInfo.title) {
    compositionName = tracksInfo.title;
    compositionNameHtml = "<h1 id=\"comp-title\" class=\"post-title\">".concat(compositionName, "</h1>");
  }
  document.getElementById('post-header').insertAdjacentHTML('afterbegin', compositionNameHtml);
};
},{"../js/config":"js/config.js","./composition":"composition/composition.js","./settings":"composition/settings.js"}],"composition/track_handler.js":[function(require,module,exports) {
"use strict";
...
var _config = require("../js/config");
var _composition_helper = require("./composition_helper");
var _composition = require("./composition");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
  ...
  _createClass(TrackHandler, [{
    ...
    value: function displayOptMenuForNewTrack(newTrack) {
      ...
      if (pos >= 0) {
        ...
        _composition.playlist.tracks[pos].customClass = customClass;
        this.createMenuOptButton(controlsList, pos, message_id, title, track_id, _composition.COMPOSITION_ID);
      }
    }
  }, {
    key: "displayOptMenuForTracks",
    value: function displayOptMenuForTracks(role) {
      var menuBtns = document.querySelectorAll('.menuoptbtn');
      if (menuBtns.length) {
        document.querySelectorAll('.menuoptbtn').forEach(function (e) {
          return e.remove();
        });
      }
      var controlsList = document.getElementsByClassName('controls');
      var arrayTracks = _composition.playlist.getInfo().tracks;
      for (var i = 0; i < arrayTracks.length; i++) {
        if (arrayTracks && arrayTracks[i].customClass) {
          if (role === 1 || role === 2 || role === 3 && arrayTracks[i].customClass.user_id === _composition_helper.CURRENT_USER_ID) {
    ...
    value: function sendDeleteRequest(pos, track_id, doAfterDeleted) {
      (0, _composition_helper.startLoader)(_composition.LOADER_ELEM_ID);
      fetch(_config.ENDPOINT + '/deletetrack/' + track_id, {
        ...
        console.log(err);
        (0, _composition_helper.cancelLoader)(_composition.LOADER_ELEM_ID);
      });
    }
  }, {
    key: "doAfterDeleted",
    value: function doAfterDeleted(deleteTrackResult, pos) {
      ...
      if (deleteTrackResult.ok) {
        var role = deleteTrackResult.role;
        var arrayTracks = _composition.playlist.tracks;
        var ee = _composition.playlist.getEventEmitter();
...
},{"../js/config":"js/config.js","./composition_helper":"composition/composition_helper.js","./composition":"composition/composition.js"}],"composition/fileuploader.js":[function(require,module,exports) {
"use strict";
...
var FileUploader = /*#__PURE__*/function () {
  function FileUploader(compositionId, trackhandler, loaderElementId) {
  ...
  _createClass(FileUploader, [{
    ...
    value: function sendData(file, type) {
      ...
      formData.append('user_info', _composition.USER_INFO);
      XHR.addEventListener('load', function (event) {
        ...
        if (event.srcElement && event.srcElement.response) {
          ...
          if (respJson.ok) {
            fileInput.value = '';
            _this3.lastupload = respJson;
            if (type === 'blob') {
              _composition.trackHandler.displayOptMenuForNewTrack(respJson);
            }
          } else {
...
},{"../js/config":"js/config.js","./composition":"composition/composition.js","./composition_helper":"composition/composition_helper.js"}],"../node_modules/process/browser.js":[function(require,module,exports) {
...
},{"process":"../node_modules/process/browser.js","buffer":"../node_modules/buffer/index.js"}],"composition/record.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(Recorder, [{
    ...
    value: function init() {
      ...
      var gotStream = function gotStream(stream) {
        ...
        _composition.playlist.initRecorder(userMediaStream);
...
},{"./composition":"composition/composition.js"}],"composition/composition.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.trackHandler = exports.setUserPermission = exports.setUser = exports.recorder = exports.playlist = exports.fileUploader = exports.USER_PERMISSION = exports.USER_INFO = exports.LOADER_ELEM_ID = exports.COMPOSITION_ID = void 0;
...
var COMPOSITION_ID = parseFloat(queryString.split('compositionId=')[1]);
exports.COMPOSITION_ID = COMPOSITION_ID;
...
exports.trackHandler = trackHandler;
var fileUploader = new _fileuploader.FileUploader(COMPOSITION_ID, trackHandler, LOADER_ELEM_ID);
exports.fileUploader = fileUploader;
var recorder = new _record.Recorder();
exports.recorder = recorder;
var compositionId = COMPOSITION_ID;
(0, _composition_helper.getComposition)(compositionId, _composition_helper.doAfterCompositionFetched);
},{"./track_handler":"composition/track_handler.js","./fileuploader":"composition/fileuploader.js","waveform-playlist":"../node_modules/waveform-playlist/build/waveform-playlist.umd.js","./composition_helper":"composition/composition_helper.js","./record":"composition/record.js"}],"composition/eventemitter.js":[function(require,module,exports) {
"use strict";
...
$container.on("click", ".btn-loop", function () {
  isLooping = true;
  playoutPromises = _composition.playlist.play(startTime, endTime);
});
...
$container.on("click", ".btn-stop", function () {
  ...
  if (isRecording) {
    isRecording = false;
    if (_composition.USER_PERMISSION) {
      var newTrackPos = _composition.playlist.getInfo().tracks.length - 1;
...
$container.on("click", ".btn.print", function () {
  console.log(_composition.playlist.getInfo());
});
...
$container.on("change", ".select-seek-style", function (node) {
  _composition.playlist.setSeekStyle(node.target.value);
});
...
ee.on("audiosourcesrendered", function () {
  if (_composition.USER_PERMISSION) {
    var lastPosTrack = _composition.playlist.tracks.length - 1;
    var lasttrack = _composition.playlist.tracks[lastPosTrack];
    if (!lasttrack.customClass) {
      _composition.trackHandler.displayOptMenuForNewTrack(_composition.fileUploader.lastupload);
    }
  }
...
ee.on('audiorenderingfinished', function (type, data, trackPos) {
  ...
  if (trackPos >= 0 && _composition.USER_PERMISSION) {
    data.name = 'audio';
    data.fileName = Date.now() + '.wav';
    _composition.fileUploader.sendData(data, 'blob');
  } else if (type == 'wav') {
    if (downloadUrl) {
...
},{"./composition":"composition/composition.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","composition/eventemitter.js"], null)
//# sourceMappingURL=eventemitter.d7afdebf.js.map