...
})({"3y1r8":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "653130274962e248";
"use strict";
...
},{}],"2SlSr":[function(require,module,exports) {
/* TODO: REFACTORING */ var _config = require("../../common/js/config");
...
const profilePageTermsAccepted = (termsAccepted)=>{
    if (!termsAccepted) (0, _acceptterms.generateAcceptTermsModal)("main");
};
const getUser = async (callback)=>{
    const data = await (0, _utils.callJsonApi)("/profile", "GET");
...
const disableEdition = async ()=>{
    ...
    if (CURRENT_USERNAME === newname) setBackToReadOnly();
    else {
        const body = {
            user_name: newname
        };
        const resultNewName = await (0, _utils.callJsonApi)("/updateusername", "PATCH", body);
        if (!resultNewName.ok) {
...
},{"../../common/js/config":"ecGaw","../../common/js/utils":"g7t25","../../common/js/acceptterms":"8SvwY"}],"ecGaw":[function(require,module,exports) {
...
},{}],"g7t25":[function(require,module,exports) {
...
},{"./config":"ecGaw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gkKU3":[function(require,module,exports) {
...
},{}],"8SvwY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./utils":"g7t25","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["3y1r8","2SlSr"], "2SlSr", "parcelRequire1e7e")

//# sourceMappingURL=profile.4962e248.js.map
