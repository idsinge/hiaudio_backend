...
},{"./config":"common/js/config.js"}],"pages/login/login.js":[function(require,module,exports) {
"use strict";
...
var redirectToGoogleLogin = function redirectToGoogleLogin() {
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          loginEmail = document.getElementById('inputloginemail').value;
          if (!(0, _utils.looksLikeMail)(loginEmail)) {
            _context2.next = 8;
            break;
          }
          _context2.next = 4;
          return (0, _utils.callJsonApi)('/generatelogincode/' + loginEmail, 'PUT');
        case 4:
          data = _context2.sent;
          if (data.ok) {
...
var requestCodeValidation = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var codeIs, sixDigits, body, data;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          codeIs = document.getElementById('verificationCode').value;
          sixDigits = /\d{6}/;
          ...
          _context3.next = 6;
          return (0, _utils.callJsonApi)('/logincodevalidation', 'POST', body);
        case 6:
          data = _context3.sent;
          if (data.ok) {
            TEMP_EMAIL = null;
  ...
  return function requestCodeValidation() {
...
getUser();
},{"../../common/js/utils":"common/js/utils.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","pages/login/login.js"], null)
