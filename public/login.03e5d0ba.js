...
})({"2Ehe1":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "24246f0a03e5d0ba";
"use strict";
...
const sendVerificationCode = async ()=>{
    ...
    if ((0, _utils.looksLikeMail)(loginEmail)) {
        const data = await (0, _utils.callJsonApi)("/generatelogincode/" + loginEmail, "PUT");
        if (data.ok) {
...
const requestCodeValidation = async ()=>{
    ...
    if (sixDigits.test(codeIs)) {
        ...
        const data = await (0, _utils.callJsonApi)("/logincodevalidation", "POST", body);
        if (data.ok) {
            TEMP_EMAIL = null;
...
document.getElementById("inputloginemail").onkeydown = function(e) {
    if (e.key == "Enter") return sendVerificationCode();
};
...
document.getElementById("verificationCode").onkeydown = function(e) {
    if (e.key == "Enter") return requestCodeValidation();
};
getUser();

},{"../../common/js/utils":"g7t25"}],"g7t25":[function(require,module,exports) {
...
},{"./config":"ecGaw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ecGaw":[function(require,module,exports) {
...
},{}]},["2Ehe1","dnRSK"], "dnRSK", "parcelRequire1e7e")

//# sourceMappingURL=login.03e5d0ba.js.map
