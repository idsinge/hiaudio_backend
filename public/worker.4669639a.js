...
})({"eaPtH":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "348dd33c4669639a";
"use strict";
...
},{}],"azHZD":[function(require,module,exports) {
// Listen for messages from the main thread
addEventListener("message", (message)=>{
    if (message.data.command === "correlation") calculateCrossCorrelation(message.data.data1, message.data.data2, message.data.maxLag, message.data.channel);
    if (message.data.command === "findpeak") findPeakAndMean(message.data.array, message.data.channel);
});
...
},{}]},["eaPtH","azHZD"], "azHZD", "parcelRequire1e7e")

//# sourceMappingURL=worker.4669639a.js.map
