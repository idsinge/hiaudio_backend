...
if (isAuthenticated) {
  document.getElementById('menuRight').innerHTML = "<a class=\"button\" href=\"".concat(window.location.origin, "/profile\">Profile</a>\n  <div>\n      <input type=\"text\" class=\"newtitle\" id=\"newtitle\" placeholder=\"new song title\" title=\"newtitle\" >\n      <input type=\"submit\" id=\"newsong\" value=\"Create new song\"></input>\n  </div>");
} else {
  document.getElementById('menuRight').innerHTML = "<a class=\"button\" href=\"".concat(window.location.origin, "/login\">Google Login</a>");
}
fetch(_config.ENDPOINT + '/songs', {
  method: 'GET',
  headers: {
...
var renderHomePage = function renderHomePage(songsList, error) {
...
var paintListOfSongs = function paintListOfSongs(songsList) {
  songsList.forEach(function (element) {
    if (element) {
      ...
      var template = "\n        <div class=\"grid-div\">\n          <div class=\"card\">\n            <a href=\"".concat(uriSongPage + element.id, "\">\n              <img src=\"").concat(element.photo_url || _agp.default, "\" alt=\"Card image cap\" class=\"card-img\">\n            </a>\n            <div class=\"card-container\">\n              <a href=\"").concat(uriSongPage + element.id, "\" class=\"card-link blue\">").concat(element.title, "</a>\n              <p>").concat(collection, "</p>\n            </div>\n          </div>\n        </div>\n      ");
...
var newProjectButton = document.getElementById('newsong');
newProjectButton && newProjectButton.addEventListener("click", function (e) {
  ...
  fetch(_config.ENDPOINT + '/newsong', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      'Accept': 'application/json'
