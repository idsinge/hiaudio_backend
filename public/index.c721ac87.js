function e(e,t,l,o){Object.defineProperty(e,t,{get:l,set:o,enumerable:!0,configurable:!0})}var t=globalThis,l={},o={},i=t.parcelRequire1e7e;null==i&&((i=function(e){if(e in l)return l[e].exports;if(e in o){var t=o[e];delete o[e];var i={id:e,exports:{}};return l[e]=i,t.call(i.exports,i,i.exports),i.exports}var n=Error("Cannot find module '"+e+"'");throw n.code="MODULE_NOT_FOUND",n}).register=function(e,t){o[e]=t},t.parcelRequire1e7e=i);var n=i.register;n("27Lyk",function(t,l){e(t.exports,"register",()=>o,e=>o=e);var o,i=new Map;o=function(e,t){for(var l=0;l<t.length-1;l+=2)i.set(t[l],{baseUrl:e,path:t[l+1]})}}),n("9QUIF",function(e,t){let l="STAGE",o={PROD:{ENDPOINT:"",UPLOAD_ENDPOINT:""},STAGE:{ENDPOINT:window.location.protocol+"//"+window.location.host,UPLOAD_ENDPOINT:window.location.protocol+"//"+window.location.host+"/fileUpload"},DEV:{ENDPOINT:window.location.protocol+"//"+window.location.host,UPLOAD_ENDPOINT:window.location.protocol+"//"+window.location.host+"/fileUpload"}};e.exports={ENDPOINT:o[l].ENDPOINT,UPLOAD_ENDPOINT:o[l].UPLOAD_ENDPOINT}}),n("eGMSd",function(t,l){e(t.exports,"default",()=>o);var o=new class{constructor(){if(this.modal=this.getDynamicModal(),this.callbackDismiss=null,!this.modal){this.modal=this.initDynamicModal();let e=this;$(this.modal).on("hide.bs.modal",function(t){e.callbackDismiss&&(e.callbackDismiss(),e.callbackDismiss=null)})}}dynamicModalDialog(e,t,l,o,i,n,a){this.setDynamicModalContent('<div class="modal-header '+n+' text-white"><h5 class="modal-title" id="dynamicModalLabel">'+i+'</h5><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button></div><div class="modal-body">'+e+'</div><div class="modal-footer"><button type="button" class="btn btn-secondary" data-dismiss="modal">'+o+"</button>"+(null!==t?"<button id="+t+' type="button" class="btn btn-primary">'+l+"</button>":"")+"</div>"),this.callbackDismiss=a,$(this.modal).modal("show")}getDynamicModal(){return document.getElementById("dynamicModal")}setDynamicModalContent(e){this.modal.querySelector(".modal-content").innerHTML=e}closeDynamicModal(e){$(this.modal).modal("hide"),e&&e()}initDynamicModal(){let e=document.createElement("div");return e.classList.add("modal","fade"),e.setAttribute("id","dynamicModal"),e.setAttribute("tabindex","-1"),e.setAttribute("role","dialog"),e.setAttribute("aria-labelledby","dynamicModalLabel"),e.setAttribute("aria-hidden","true"),e.innerHTML='<div class="modal-dialog modal-sm modal-dialog-centered" role="document"><div class="modal-content"></div></div>',document.body.appendChild(e),e}}}),n("ck9ES",function(t,l){e(t.exports,"LOADER_ELEM_ID",()=>n),e(t.exports,"uriUserPage",()=>a),e(t.exports,"uriCollectionPage",()=>s),e(t.exports,"LevelPrivacy",()=>c),e(t.exports,"PRIVACY_BADGE_STYLE",()=>r),e(t.exports,"PRIVACY_BADGE_TEXT",()=>d),e(t.exports,"startLoader",()=>u),e(t.exports,"cancelLoader",()=>m),e(t.exports,"callJsonApi",()=>p),e(t.exports,"looksLikeMail",()=>g),e(t.exports,"activateGoHomeLink",()=>b),e(t.exports,"MEDIA_CONSTRAINTS",()=>h);var o=i("9QUIF");let n="loader",a="/index.html?userid=",s="/index.html?collectionid=";Object.freeze({none:0,owner:1,admin:2,member:3,guest:4});let c=Object.freeze({public:1,onlyreg:2,private:3}),r={[c.public]:"badge-public",[c.onlyreg]:"badge-onlyreg",[c.private]:"badge-private"},d={[c.public]:"PUBLIC",[c.onlyreg]:"REG USERS",[c.private]:"PRIVATE"},u=(e,t)=>{let l=document.getElementById(e);l.nextElementSibling.textContent=t,l.classList.add(e)},m=e=>{let t=document.getElementById(e);t.classList.remove(e),t.nextElementSibling.textContent=""},p=async(e,t,l)=>{let i={method:t||"GET",headers:{"Content-Type":"application/json",Accept:"application/json"}};l&&(i.body=JSON.stringify(l));try{u(n,"Loading...");let t=await fetch(o.ENDPOINT+e,i);m(n);let l=await t.json();if(l&&!l.error)return l;return l?.error||"An error occurred"}catch(e){return m(n),e}},g=e=>{let t=e.lastIndexOf("@"),l=e.lastIndexOf(".");return t<l&&t>0&&-1==e.indexOf("@@")&&l>2&&e.length-l>2},b=()=>{let e=document.getElementById("goHome");"localhost:80"===window.location.host||"http://localhost"===window.location.origin?e.href=window.location.origin+"/index.html":e.href=window.location.origin};/^((?!chrome|android).)*safari/i.test(navigator.userAgent);let h={audio:{echoCancellation:!1,noiseSuppression:!1,autoGainControl:!1,latency:0,channelCount:1}}}),n("hcAI8",function(t,l){e(t.exports,"checkIfTermsAccepted",()=>n),e(t.exports,"generateAcceptTermsModal",()=>r);var o=i("ck9ES");let n=(e,t)=>{(0,o.cancelLoader)(o.LOADER_ELEM_ID),t(e?.terms_accepted)},a=()=>{$("#acceptTermsModal").modal({backdrop:"static",keyboard:!1}),$("#acceptTermsModal").modal("show"),document.getElementById("buttonAcceptTerms").onclick=s,document.getElementById("buttonRejectTerms").onclick=c},s=async()=>{(await (0,o.callJsonApi)("/acceptterms","PUT")).ok&&$("#acceptTermsModal").modal("hide")},c=async()=>{(await (0,o.callJsonApi)("/rejectterms","PUT")).ok&&($("#acceptTermsModal").modal("hide"),window.location.href=window.location.origin)},r=e=>{if(!document.getElementById("acceptTermsModal")){let t=`<div class="modal fade" id="acceptTermsModal" tabindex="-1" role="dialog">
  ...
  <div class='fullscreen-video-content'>
    ...
    <div class="h-100 d-flex">
      <div class="m-auto">
        <a id="start-link" class="btn btn-link" href="/login.html" role="button"><b>LET'S START?</b></a>
...
</div>`,_=(e,t,l,o,i)=>{let n=e||!g(o)&&t||l;return`<ul class="nav justify-content-end">
            ...
            </div>`},P=(e,t,l,o,i)=>{let n=k[e],a=B[e],s=L[e],c=`<span class="badge ${n} d-inline-block text-truncate" style="max-width:85%;">
            ...
            </div>`},S=e=>{let t=document.getElementById("welcomecontainer"),l=document.getElementById("landing-video-container");if(t.lastChild?.id&&t.lastChild?.id!=="welcometext"&&t.removeChild(t.lastChild),!e&&!t.lastChild&&!l){let e=document.createElement("div");e.id="welcometext",e.innerHTML=j?"":`${M}`,document.getElementById("welcomecontainer").appendChild(e)}},R=(e,t,l)=>{S(!0);let o=document.createElement("div");o.id="infocontainer",o.innerHTML=`<div class="card border-collection mb-3">
    ...
    `,(0,c.activateGoHomeLink)(),ee();var et=i("lRrDz"),a=i("9QUIF");let el=!1;const eo=document.getElementById("openMyCollectionsButton"),ei=document.getElementById("editmycollectionsbutton"),en=async()=>{let e=await fetch("/mycollectionsastree");return await e.json()},ea=e=>{let t=`
