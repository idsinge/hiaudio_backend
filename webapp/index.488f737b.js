...
var paintListOfSongs = function paintListOfSongs(songsList) {
  songsList.forEach(function (element) {
    if (element) {
      ...
      var template = "\n        <div class=\"grid-div\">\n          <div class=\"card\">\n            <a href=\"../webapp/song/song.html?songId=".concat(element.id, "\">\n              <img src=\"").concat(element.photo_url || _agp.default, "\" alt=\"Card image cap\" class=\"card-img\">\n            </a>\n            <div class=\"card-container\">\n              <a href=\"../webapp/song/song.html?songId=").concat(element.id, "\" class=\"card-link blue\">").concat(element.title, "</a>\n              <p>").concat(collection, "</p>\n            </div>\n          </div>\n        </div>\n      ");
...
newProjectButton && newProjectButton.addEventListener("click", function (e) {
  ...
  fetch(_config.ENDPOINT + '/newsong', {
    ...
    if (data.song) {
      window.location.href = '/webapp/song/song.html?songId=' + data.song.id;
    } else {
