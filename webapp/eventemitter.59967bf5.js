...
exports.telegramLoginCallback = exports.startLoader = exports.getSong = exports.doFetch = exports.doAfterSongFetched = exports.cancelLoader = void 0;
...
var telegramLoginCallback = function telegramLoginCallback(telegramUser) {
  (0, _song.setUser)(telegramUser);
  var userInfo = JSON.parse(telegramUser);
  var songId = _song.SONG_ID;
  var query = "query GetUserPermission($songId: Float!, $userInfo: UserInfo) {\n        songInfoById(songId: $songId, userInfo: $userInfo ){user_permission}\n    }";
...
exports.telegramLoginCallback = telegramLoginCallback;
...
var successfulLoginAtPage = function successfulLoginAtPage(info) {
...
var TrackHandler = /*#__PURE__*/function () {
  ...
  _createClass(TrackHandler, [{
    ...
    value: function displayOptMenuForNewTrack(newTrack) {
      ...
      var track_id = audio.file_unique_id + '_' + element.message.date;
    ...
    value: function sendDeleteRequest(pos, chat_id, message_id, track_id, doAfterDeleted) {
      ...
      var userInfo = JSON.parse(_song.USER_INFO);
      var query = "query DeleteTrack($chat_id: Float!, $message_id: Int!, $track_id: String!, $userInfo: UserInfo!) {\n            deleteMessage(chat_id: $chat_id, message_id: $message_id, track_id: $track_id, userInfo: $userInfo ){ ok, description }\n        }";
      var body = JSON.stringify({
        query: query,
        variables: {
          chat_id: chat_id,
      ...
      (0, _song_helper.doFetch)(body, doAfterDeleted, pos);
    }
  }, {
    key: "doAfterDeleted",
...
},{"./song_helper":"song/song_helper.js","./song":"song/song.js"}],"song/fileuploader.js":[function(require,module,exports) {
"use strict";
